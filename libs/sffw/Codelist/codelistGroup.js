        ...
        (function (codelist) {
            var CodelistGroup = /** @class */ (function () {
                ...
                CodelistGroup.prototype.finishBackgroundLoadingAsync = function () {
                    return this.loadingPromise || Promise.resolve(this.lastLoadingResult || new codelist.CodelistGroupLoadingResult('Loading has not finished yet'));
                };
...
(function (sffw) {
    ...
    (function (api) {
        var codelist;
        (function (codelist) {
            // type failedCodelist = { name: string, error: string };
            var CodelistGroupLoadingResult = /** @class */ (function () {
                function CodelistGroupLoadingResult(generalError) {
                    this.failedCodelists = [];
                    this.generalError = generalError;
                }
                CodelistGroupLoadingResult.prototype.isError = function () {
                    return !!(this.generalError || this.failedCodelists.length > 0);
                };
                CodelistGroupLoadingResult.prototype.getErrorMessage = function () {
                    return this.generalError
                        || (this.failedCodelists.length > 0 ? "Failed to load codelist(s): " + _.map(this.failedCodelists, function (fc) { return fc[0]; }).join(', ') + "." : null);
                };
                return CodelistGroupLoadingResult;
            }());
            codelist.CodelistGroupLoadingResult = CodelistGroupLoadingResult;
        })(codelist = api.codelist || (api.codelist = {}));
    })(api = sffw.api || (sffw.api = {}));
})(sffw || (sffw = {}));
var sffw;
